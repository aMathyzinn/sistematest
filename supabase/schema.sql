...
-- ATENÇÃO: derruba e recria todas as tabelas
-- ============================================================
...
-- ============================================================
-- USERS — autenticação via token único (sem email/senha)
-- ============================================================
create table users (
  ...
  settings     jsonb       not null default '{"aiModel":"openai/gpt-4o-mini","pomodoro":{"focusDuration":25,"breakDuration":5,"longBreakDuration":15,"sessionsUntilLongBreak":4},"soundEnabled":true,"notificationsEnabled":false,"language":"pt-BR"}',
  ui_settings  jsonb       not null default '{"theme":"dark","sections":[{"id":"xp-summary","title":"Nível & XP","type":"xp_summary","order":0,"visible":true},{"id":"missions-today","title":"Missões de Hoje","type":"missions_today","order":1,"visible":true},{"id":"tasks-preview","title":"Tarefas","type":"tasks_preview","order":2,"visible":true},{"id":"pomodoro-widget","title":"Pomodoro","type":"pomodoro_widget","order":3,"visible":true},{"id":"routine-today","title":"Rotina","type":"routine_today","order":4,"visible":true}]}',
